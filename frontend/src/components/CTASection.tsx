  ...
  return (
    <section className="bg-gradient-to-br from-hero-foreground via-gray-900 to-feature py-24 px-4">
      <div className="max-w-4xl mx-auto text-center space-y-8">
        <div className="inline-flex items-center gap-2 bg-card/10 rounded-pill px-4 py-2 text-sm text-white/80 border border-card/10">
        ...
        <p className="text-lg text-zinc-300 max-w-xl mx-auto">
          Get started in seconds. No credit card required. Create your free TapONN
